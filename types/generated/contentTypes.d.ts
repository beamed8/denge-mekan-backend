...
export interface ApiEmlakEmlak extends Struct.CollectionTypeSchema {
  collectionName: 'emlaks';
  info: {
    displayName: 'Emlak';
    pluralName: 'emlaks';
    singularName: 'emlak';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::emlak.emlak'> &
      Schema.Attribute.Private;
    lokasyon: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resimler: Schema.Attribute.Media<
